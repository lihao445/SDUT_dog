...
// 0  walk
{
{{12,0.01, 0.02 },{1.5,0.01, 0.05}},{{12, 0.01, 0.02},{1.5,0.01,0.05}},
{{12,0.01, 0.02},{1.5,0.01, 0.05}},{{12, 0.01, 0.02},{1.5,0.01,0.05}},
},

	// 1  trot
{
{{14,0.01, 0.1 },{1.5,0, 0.2}},{{14, 0.01, 0.1},{1.5,0,0.2}},
	{{14.0, 0.01, 0.1},{1.5,0, 0.2}},{{14, 0.01, 0.1},{1.5,0,0.2}}
},
...
// 9 jump prep
{
{{0.8,0.005, 0.4 },{1.0,0, 0.2}},{{0.8, 0.005, 0.4},{1.0,0,0.2}},
	{{0.8, 0.005, 0.4},{1.0,0, 0.2}},{{0.8, 0.005, 0.4},{1.0,0,0.2}}
},

// 10 stop
{
{{11,0.01, 0.05 },{1.05,0.01, 0.1}},{{11, 0.01, 0.05},{1.05,0.01,0.1}},
{{11,0.01, 0.05},{1.05,0.01, 0.1}},{{11, 0.01, 0.05},{1.05,0.01,0.1}},
},
...
//// 10 stop
//{
//{{11,0.01, 0.02 },{1,0.01, 0.05}},{{11, 0.01, 0.02},{1,0.01,0.05}},
//{{11,0.01, 0.02},{1,0.01, 0.05}},{{11, 0.01, 0.02},{1,0.01,0.05}},
//},
